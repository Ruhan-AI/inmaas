...
export function WhatsAppButton() {
  return (
    <a
      ...
      className="fixed bottom-6 end-6 z-40 flex h-14 w-14 items-center justify-center rounded-full bg-whatsapp-gradient text-white shadow-elevated transition-transform duration-300 hover:scale-110 active:scale-95 group focus:outline-none focus:ring-2 focus:ring-green-400 focus:ring-offset-2"
    >
      <svg
